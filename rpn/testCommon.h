...
void assertEqualsMatrixAndValuesFunc(double a[N][N], double *b, int r, int c, char *fname, int line);
...
#define assertEqualsMatrixAndValues(a, b, r, c) assertEqualsMatrixAndValuesFunc(a, b, r, c, __FILE__, __LINE__)
